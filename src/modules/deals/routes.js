...
router.post('/:dealId/communications',
  dealLimiter,
  authenticateUser,
  authorizeRoles(['creator', 'manager', 'agency_owner', 'agency_member']),
  authorizeSubscription(DEAL_ALLOWED_TIERS),
...
router.get('/:dealId/communications',
  dealLimiter,
  authenticateUser,
  authorizeRoles(['creator', 'manager', 'agency_owner', 'agency_member']),
  authorizeSubscription(DEAL_ALLOWED_TIERS),
...
// Deliverables routes
router.post('/:dealId/deliverables',
  dealLimiter,
  authenticateUser,
  authorizeRoles(['creator', 'manager', 'agency_owner', 'agency_member']),
  authorizeSubscription(DEAL_ALLOWED_TIERS),
...
router.put('/:dealId/communications/:commId',
  dealLimiter,
  authenticateUser,
  authorizeRoles(['creator', 'manager', 'agency_owner', 'agency_member']),
  authorizeSubscription(DEAL_ALLOWED_TIERS),
...
// Quick actions route
router.post('/:dealId/actions/:action',
  dealLimiter,
  authenticateUser,
  authorizeRoles(['creator', 'manager', 'agency_owner', 'agency_member']),
  authorizeSubscription(DEAL_ALLOWED_TIERS),
